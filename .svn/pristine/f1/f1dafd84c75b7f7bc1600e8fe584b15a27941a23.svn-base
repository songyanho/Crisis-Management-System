...
*/
abstract class Admin extends ChildUser implements ActiveRecordInterface
{
    /**
     * TableMap class name
     */
    ...
    public function setTel($v)
    {
        ...
        if ($this->tel !== $v) {
            $this->tel = $v;
            $this->modifiedColumns[AdminTableMap::COL_TEL] = true;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 4 + $startcol : AdminTableMap::translateFieldName('Tel', TableMap::TYPE_PHPNAME, $indexType)];
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(AdminTableMap::COL_TEL)) {
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(AdminTableMap::COL_TEL)) {
            $criteria->add(AdminTableMap::COL_TEL, $this->tel);
        }
        if ($this->isColumnModified(AdminTableMap::COL_CREATED_AT)) {
    ...
    public function hashCode()
    {
        ...
        //relation admin_fk_ffc53a to table user
    ...
    public function getParentOrCreate($con = null)
    {
        if ($this->isNew()) {
            if ($this->isPrimaryKeyNull()) {
                ...
                $parent->setDescendantClass('Admin');
