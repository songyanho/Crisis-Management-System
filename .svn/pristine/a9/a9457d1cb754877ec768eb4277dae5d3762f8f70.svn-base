 ...
 *
 * @method     ChildCategoryQuery leftJoinIncidentCategory($relationAlias = null) Adds a LEFT JOIN clause to the query using the IncidentCategory relation
 * @method     ChildCategoryQuery rightJoinIncidentCategory($relationAlias = null) Adds a RIGHT JOIN clause to the query using the IncidentCategory relation
 * @method     ChildCategoryQuery innerJoinIncidentCategory($relationAlias = null) Adds a INNER JOIN clause to the query using the IncidentCategory relation
 *
 * @method     ChildCategoryQuery joinWithIncidentCategory($joinType = Criteria::INNER_JOIN) Adds a join clause and with to the query using the IncidentCategory relation
 *
 * @method     ChildCategoryQuery leftJoinWithIncidentCategory() Adds a LEFT JOIN clause and with to the query using the IncidentCategory relation
 * @method     ChildCategoryQuery rightJoinWithIncidentCategory() Adds a RIGHT JOIN clause and with to the query using the IncidentCategory relation
 * @method     ChildCategoryQuery innerJoinWithIncidentCategory() Adds a INNER JOIN clause and with to the query using the IncidentCategory relation
 *
 * @method     \IncidentCategoryQuery endUse() Finalizes a secondary criteria and merges it with its primary Criteria
 *
...
abstract class CategoryQuery extends ModelCriteria
{
     ...
     */
    public function __construct($dbName = 'cms', $modelName = '\\Category', $modelAlias = null)
    {
    ...
    public function filterByIncidentCategory($incidentCategory, $comparison = null)
    {
        if ($incidentCategory instanceof \IncidentCategory) {
            return $this
                ->addUsingAlias(CategoryTableMap::COL_ID, $incidentCategory->getCategoryId(), $comparison);
