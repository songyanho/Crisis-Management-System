...
/**
 * Base class that represents a row from the 'login_session' table.
 *
 *
 *
...
abstract class LoginSession implements ActiveRecordInterface
{
     ...
     * TableMap class name
     */
    const TABLE_MAP = '\\Map\\LoginSessionTableMap';
    ...
    /**
     * Initializes internal state of Base\LoginSession object.
     */
     ...
     * @return $this|\LoginSession The current object (for fluent API support)
     */
    ...
    public function setUserType($v)
    {
        ...
        if ($this->user_type !== $v) {
            $this->user_type = $v;
            $this->modifiedColumns[LoginSessionTableMap::COL_USER_TYPE] = true;
        }
    ...
    public function setUserId($v)
    {
        ...
        if ($this->user_id !== $v) {
            $this->user_id = $v;
            $this->modifiedColumns[LoginSessionTableMap::COL_USER_ID] = true;
        }
    ...
    public function setSessionId($v)
    {
        ...
        if ($this->session_id !== $v) {
            $this->session_id = $v;
            $this->modifiedColumns[LoginSessionTableMap::COL_SESSION_ID] = true;
        }
    ...
    public function setSessionKey($v)
    {
        ...
        if ($this->session_key !== $v) {
            $this->session_key = $v;
            $this->modifiedColumns[LoginSessionTableMap::COL_SESSION_KEY] = true;
        }
    ...
    public function setDisabled($v)
    {
        ...
        if ($this->disabled !== $v) {
            $this->disabled = $v;
            $this->modifiedColumns[LoginSessionTableMap::COL_DISABLED] = true;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : LoginSessionTableMap::translateFieldName('Id', TableMap::TYPE_PHPNAME, $indexType)];
            $this->id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : LoginSessionTableMap::translateFieldName('UserType', TableMap::TYPE_PHPNAME, $indexType)];
            $this->user_type = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : LoginSessionTableMap::translateFieldName('UserId', TableMap::TYPE_PHPNAME, $indexType)];
            $this->user_id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 3 + $startcol : LoginSessionTableMap::translateFieldName('SessionId', TableMap::TYPE_PHPNAME, $indexType)];
            $this->session_id = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 4 + $startcol : LoginSessionTableMap::translateFieldName('SessionKey', TableMap::TYPE_PHPNAME, $indexType)];
            $this->session_key = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 5 + $startcol : LoginSessionTableMap::translateFieldName('Disabled', TableMap::TYPE_PHPNAME, $indexType)];
            ...
            throw new PropelException(sprintf('Error populating %s object', '\\LoginSession'), 0, $e);
        }
    }
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(LoginSessionTableMap::COL_USER_TYPE)) {
            $modifiedColumns[':p' . $index++]  = 'user_type';
        }
        if ($this->isColumnModified(LoginSessionTableMap::COL_USER_ID)) {
            $modifiedColumns[':p' . $index++]  = 'user_id';
        }
        if ($this->isColumnModified(LoginSessionTableMap::COL_SESSION_ID)) {
            $modifiedColumns[':p' . $index++]  = 'session_id';
        }
        if ($this->isColumnModified(LoginSessionTableMap::COL_SESSION_KEY)) {
            $modifiedColumns[':p' . $index++]  = 'session_key';
        }
        if ($this->isColumnModified(LoginSessionTableMap::COL_DISABLED)) {
        ...
        $sql = sprintf(
            'INSERT INTO login_session (%s) VALUES (%s)',
    ...
    public function toArray($keyType = TableMap::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array())
    {
        ...
        $result = array(
            ...
            $keys[4] => $this->getSessionKey(),
            $keys[5] => $this->getDisabled(),
    ...
    public function fromArray($arr, $keyType = TableMap::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[4], $arr)) {
            $this->setSessionKey($arr[$keys[4]]);
        }
        if (array_key_exists($keys[5], $arr)) {
            $this->setDisabled($arr[$keys[5]]);
        }
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(LoginSessionTableMap::COL_USER_TYPE)) {
            $criteria->add(LoginSessionTableMap::COL_USER_TYPE, $this->user_type);
        }
        if ($this->isColumnModified(LoginSessionTableMap::COL_USER_ID)) {
            $criteria->add(LoginSessionTableMap::COL_USER_ID, $this->user_id);
        }
        if ($this->isColumnModified(LoginSessionTableMap::COL_SESSION_ID)) {
            $criteria->add(LoginSessionTableMap::COL_SESSION_ID, $this->session_id);
        }
        if ($this->isColumnModified(LoginSessionTableMap::COL_SESSION_KEY)) {
            $criteria->add(LoginSessionTableMap::COL_SESSION_KEY, $this->session_key);
        }
        if ($this->isColumnModified(LoginSessionTableMap::COL_DISABLED)) {
            $criteria->add(LoginSessionTableMap::COL_DISABLED, $this->disabled);
        }
        if ($this->isColumnModified(LoginSessionTableMap::COL_CREATED_AT)) {
     ...
     * objects.
     *
     * @param      object $copyObj An object of \LoginSession (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \LoginSession Clone of current object.
     * @throws PropelException
     */
