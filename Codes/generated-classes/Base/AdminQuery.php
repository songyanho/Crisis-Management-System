 ...
 * @method     ChildAdminQuery orderByTel($order = Criteria::ASC) Order by the tel column
 ...
 * @method     ChildAdminQuery groupByTel() Group by the tel column
 ...
 * @method     ChildAdmin findOneByTel(string $tel) Return the first ChildAdmin filtered by the tel column
 ...
 * @method     ChildAdmin requireOneByTel(string $tel) Return the first ChildAdmin filtered by the tel column and throws \Propel\Runtime\Exception\EntityNotFoundException when not found
 ...
 * @method     ChildAdmin[]|ObjectCollection findByTel(string $tel) Return ChildAdmin objects filtered by the tel column
 ...
 *
 */
abstract class AdminQuery extends ChildUserQuery
{
     ...
     */
    public function __construct($dbName = 'cms', $modelName = '\\Admin', $modelAlias = null)
    {
    ...
    {
        $sql = 'SELECT id, username, password, email, tel, created_at, updated_at FROM admin WHERE id = :p0';
        try {
    ...
    public function filterByTel($tel = null, $comparison = null)
    {
        ...
        return $this->addUsingAlias(AdminTableMap::COL_TEL, $tel, $comparison);
    }
    ...
    public function filterByUser($user, $comparison = null)
    {
        if ($user instanceof \User) {
            return $this
                ->addUsingAlias(AdminTableMap::COL_ID, $user->getId(), $comparison);
            ...
            return $this
                ->addUsingAlias(AdminTableMap::COL_ID, $user->toKeyValue('PrimaryKey', 'Id'), $comparison);
        } else {
