...
class IncidentTableMap extends TableMap
{
     ...
     */
    const COL_SEVERITY = 'incident.severity';
     ...
     */
    const COL_VERSION = 'incident.version';
    ...
    protected static $fieldNames = array (
        ...
        self::TYPE_COLNAME       => array(IncidentTableMap::COL_ID, IncidentTableMap::COL_TITLE, IncidentTableMap::COL_LOCATION, IncidentTableMap::COL_LATITUDE, IncidentTableMap::COL_LONGITUDE, IncidentTableMap::COL_ACTIVE, IncidentTableMap::COL_SEVERITY, IncidentTableMap::COL_CREATED_AT, IncidentTableMap::COL_UPDATED_AT, IncidentTableMap::COL_VERSION, ),
    ...
    protected static $fieldKeys = array (
        ...
        self::TYPE_COLNAME       => array(IncidentTableMap::COL_ID => 0, IncidentTableMap::COL_TITLE => 1, IncidentTableMap::COL_LOCATION => 2, IncidentTableMap::COL_LATITUDE => 3, IncidentTableMap::COL_LONGITUDE => 4, IncidentTableMap::COL_ACTIVE => 5, IncidentTableMap::COL_SEVERITY => 6, IncidentTableMap::COL_CREATED_AT => 7, IncidentTableMap::COL_UPDATED_AT => 8, IncidentTableMap::COL_VERSION => 9, ),
  ...
  array (
    ...
    1 => ':id',
        ...
        $this->addRelation('IncidentVersion', '\\IncidentVersion', RelationMap::ONE_TO_MANY, array (
  0 =>
  array (
    0 => ':id',
    1 => ':id',
  ),
), 'CASCADE', null, 'IncidentVersions', false);
