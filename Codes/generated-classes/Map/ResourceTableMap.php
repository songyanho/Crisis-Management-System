...
class ResourceTableMap extends TableMap
{
     ...
     */
    const COL_ID = 'resource.id';

    /**
     * the column name for the name field
     */
    const COL_NAME = 'resource.name';

    /**
     * the column name for the image field
     */
    const COL_IMAGE = 'resource.image';

    /**
     * the column name for the tel field
     */
    const COL_TEL = 'resource.tel';

    /**
     * the column name for the Sms field
     */
    const COL_SMS = 'resource.Sms';

    /**
     * the column name for the created_at field
     */
    const COL_CREATED_AT = 'resource.created_at';

    /**
     * the column name for the updated_at field
     */
    const COL_UPDATED_AT = 'resource.updated_at';
    ...
    protected static $fieldNames = array (
        self::TYPE_PHPNAME       => array('Id', 'Name', 'Image', 'Tel', 'Sms', 'CreatedAt', 'UpdatedAt', ),
        self::TYPE_CAMELNAME     => array('id', 'name', 'image', 'tel', 'sms', 'createdAt', 'updatedAt', ),
        self::TYPE_COLNAME       => array(ResourceTableMap::COL_ID, ResourceTableMap::COL_NAME, ResourceTableMap::COL_IMAGE, ResourceTableMap::COL_TEL, ResourceTableMap::COL_SMS, ResourceTableMap::COL_CREATED_AT, ResourceTableMap::COL_UPDATED_AT, ),
        self::TYPE_FIELDNAME     => array('id', 'name', 'image', 'tel', 'Sms', 'created_at', 'updated_at', ),
    ...
    protected static $fieldKeys = array (
        self::TYPE_PHPNAME       => array('Id' => 0, 'Name' => 1, 'Image' => 2, 'Tel' => 3, 'Sms' => 4, 'CreatedAt' => 5, 'UpdatedAt' => 6, ),
        self::TYPE_CAMELNAME     => array('id' => 0, 'name' => 1, 'image' => 2, 'tel' => 3, 'sms' => 4, 'createdAt' => 5, 'updatedAt' => 6, ),
        self::TYPE_COLNAME       => array(ResourceTableMap::COL_ID => 0, ResourceTableMap::COL_NAME => 1, ResourceTableMap::COL_IMAGE => 2, ResourceTableMap::COL_TEL => 3, ResourceTableMap::COL_SMS => 4, ResourceTableMap::COL_CREATED_AT => 5, ResourceTableMap::COL_UPDATED_AT => 6, ),
        self::TYPE_FIELDNAME     => array('id' => 0, 'name' => 1, 'image' => 2, 'tel' => 3, 'Sms' => 4, 'created_at' => 5, 'updated_at' => 6, ),
        self::TYPE_NUM           => array(0, 1, 2, 3, 4, 5, 6, )
    );
    ...
    public function initialize()
    {
        ...
        $this->addColumn('Sms', 'Sms', 'BOOLEAN', true, 1, null);
  ...
  array (
    ...
    public static function addSelectColumns(Criteria $criteria, $alias = null)
    {
        if (null === $alias) {
            ...
            $criteria->addSelectColumn(ResourceTableMap::COL_IMAGE);
            $criteria->addSelectColumn(ResourceTableMap::COL_TEL);
            $criteria->addSelectColumn(ResourceTableMap::COL_SMS);
